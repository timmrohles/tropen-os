...
**Applicability:** Gilt nur wenn Webhook-Routes oder Webhook-Dependencies (stripe, github-webhooks etc.) im Projekt existieren.
...
// } catch (error) {
//   return await fallbackService.getCachedData()
// }
```
...
|------|------|------|-------|----------|
| R1 | ESLint Custom Rule | pre-commit/CI | REVIEWED | strong |
