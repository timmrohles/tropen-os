...
const STEPS = [
  {
    n: 'I',
    title: 'Projekt verbinden',
    desc: 'Ordner auswählen — dein Code bleibt lokal. Wir speichern nichts. GitHub-Connect kommt bald.',
    file: '.cursorrules',
    code: `# Quality Rules — Generated by Tropen OS
...
- Never return error.message to client`,
  ...
  {
    n: 'II',
    title: 'Scan in 60 Sekunden',
    desc: '25 Kategorien. 195 Regeln. Optional: 4 KI-Modelle prüfen unabhängig im Deep Review.',
  ...
  {
    n: 'III',
    title: 'Aufgaben für deine KI',
    desc: 'Jedes Finding wird zum kopierbaren Prompt. Du musst DSGVO nicht verstehen — deine KI fixt es.',
    file: 'finding-prompt.txt',
    code: `Problem: Missing rate limiting on /api/auth
