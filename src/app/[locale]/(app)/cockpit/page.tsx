...
function CockpitSkeleton({ ariaLabel }: { ariaLabel: string }) {
  return (
    <div className="cockpit-grid" aria-busy="true" aria-label={ariaLabel}>
      {[0, 1, 2, 3].map(i => (
        <div
          key={i}
...
export default function CockpitPage() {
  ...
  return (
    <div className="content-max">
      ...
      {loading ? (
        <CockpitSkeleton ariaLabel={t('loadingAriaLabel')} />
      ) : !setupDone && !hasWidgets ? (
