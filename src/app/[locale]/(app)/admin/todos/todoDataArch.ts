...
export const TODOS_ARCH: Todo[] = [
  ...
  },
  {
    ...
    beschreibung: 'Toro soll nach erkannten Mustern Skills und Agenten vorschlagen. Spec: user_preferences: agent_suggestions + skill_suggestions DEFAULT false (opt-in). Alternative: opt-out DEFAULT true. Entscheidung vor Plan J2c. → Obsolet: J2c ist erledigt ohne dieses Feature. Konzept aufgegangen in ai-first-feedback-layer.',
    status: 'erledigt',
    kategorie: 'Architektur-Entscheidungen',
    prioritaet: 'niedrig',
