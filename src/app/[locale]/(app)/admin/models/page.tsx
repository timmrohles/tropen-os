    ...
    <div className="content-wide" aria-busy={loading}>
      ...
      <div style={s.toggleRow}>
        ...
        <button
          ...
          role="switch"
          aria-label={t('membersToggleAriaLabel')}
        >
          <span style={{
            position: 'absolute',
            top: 3,
      ...
      {showNew && (
        <div style={s.newForm}>
          ...
          <div style={{ ...s.formGrid, flexWrap: 'wrap' }}>
            ...
            <input
              style={s.input}
              placeholder={t('costInputPlaceholder')}
              type="number"
              step="0.000001"
            ...
            <input
              style={s.input}
              placeholder={t('costOutputPlaceholder')}
              type="number"
              step="0.000001"
      ...
      {loading ? (
        <div style={{ paddingTop: 48, textAlign: 'center' }}>
          <p style={{ color: 'var(--text-tertiary)' }}>{tc('loading')}</p>
        </div>
      ) : (
        <div className="card">
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              <thead>
                <tr>
                  ...
                  <th style={s.th}>{t('colProvider')}</th>
                  <th style={s.th}>{t('colCostInput')}</th>
                  <th style={s.th}>{t('colCostOutput')}</th>
