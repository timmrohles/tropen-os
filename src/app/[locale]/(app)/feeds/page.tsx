        ...
        >
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 20 }}>
              ...
              <button className="btn-icon" aria-label={tc('close')} onClick={() => setTopicModal(false)}>✕</button>
            </div>
            ...
            <div style={{ display: 'flex', gap: 8, justifyContent: 'flex-end' }}>
              <button className="btn btn-ghost" onClick={() => setTopicModal(false)}>{tc('cancel')}</button>
              <button
